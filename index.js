...
async function run() {
  ...
  try {
    ...
    app.get('/exclusive/:id', async (req, res) => {
      ...
      const options = {
        // Include only the `title` and `imdb` fields in the returned document
        projection: { type: 1, category: 1, price: 1, image: 1,  description: 1, specifications: 1, product: 1, documents: 1, picture: 1, revisions: 1, files: 1, packages: 1, times: 1, basics: 1, standards: 1, premiums: 1 },
      };
